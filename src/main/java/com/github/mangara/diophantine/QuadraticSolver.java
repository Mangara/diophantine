 ...
 * <p>
 * The method is based on K. R. Matthews, "Solving the Diophantine equation \(ax^2 + bxy + cy^2 + dx + ey + f = 0\)"
...
public class QuadraticSolver {
    ...
    private static Iterator<XYPair> solveTrivialCase(BigInteger a, BigInteger b, BigInteger c, BigInteger d, BigInteger e, BigInteger f, BigInteger D) {
